...
class _MatchedAnimationState extends State<MatchedAnimation>
  ...
  Color _correctColor = Color.fromARGB(255, 181, 255, 184);
    ...
    if (widget.animate) {
      if (!_correctColorIsSet) {
        if (widget.numberOfWordsAnswered == 4) {
          _correctColor = Color.fromARGB(255, 255, 182, 244);
        }
        if (widget.numberOfWordsAnswered == 6) {
          _correctColor = Color.fromARGB(255, 113, 236, 255);
        }
        if (widget.numberOfWordsAnswered == 8) {
          _correctColor = Color.fromARGB(255, 255, 237, 184);
        }
      }
  ...
  Widget build(BuildContext context) {
    Color _defaultColor = Theme.of(context).hintColor;
